                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input class="form-control" type="text" name="product_name"
                                                               required value="${p.title}">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label class="control-label">Giá Nhập</label>
                                                        <input class="form-control" type="number" name="inPrice"
                                                               required value="${p.inPrice}">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label class="control-label">Giá Bán</label>
                                                        <input class="form-control" type="number" name="outPrice"
                                                               required value="${p.outPrice}">
                                                    </div>
