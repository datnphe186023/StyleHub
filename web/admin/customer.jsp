...
<html lang="en">
    ...
    <body onload="time()" class="app sidebar-mini rtl">
                                    ...
                                    <c:forEach items="${requestScope.customerList}" var="customer">
                                        <tr>
                                            ...
                                            <td><button class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp" data-toggle="modal"
                                                        data-target="#ModalUP${customer.id}"><i class="fas fa-edit"></i></button></td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
        ...
        <c:forEach items="${requestScope.customerList}" var="customer">
            <div class="modal fade" id="ModalUP${customer.id}" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static"
                 data-keyboard="false">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input hidden="hidden" type="text" name="customerId" value="${customer.id}">
